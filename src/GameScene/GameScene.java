...
public class GameScene extends JSplitPane {
   ...
   private FileInput input = new FileInput("txt/word.dat", "@");
   ...
   public GameScene() {
      ...
      URL bumbURL = getClass().getResource("bumb.wav");
      clip_bumb = Applet.newAudioClip(bumbURL);
